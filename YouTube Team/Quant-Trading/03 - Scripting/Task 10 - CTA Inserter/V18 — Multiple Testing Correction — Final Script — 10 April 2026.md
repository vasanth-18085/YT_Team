...
[CTA 1]
If you want to apply these corrections to your own model comparisons, the free starter pack has the multiple testing correction config, the implementation references, and the decision table for choosing between methods. In the description.
...
[CTA 2]
The multiple testing correction decision table is in the free starter pack — link in the description.
