# V16 — Transaction Costs — Final Script
...
[CTA 1]
If you want to model transaction costs properly in your own backtests, the free starter pack has the cost layer config, the slippage calibration method, and the break-even frequency calculator. In the description.
...
[CTA 2]
The transaction cost config and break-even calculator are in the free starter pack — link in the description.
