...
[CTA 1]
If you want to implement Kelly-based position sizing, the free starter pack has the position sizing config, the fractional Kelly derivation, and the volatility-targeting parameters. Grab it from the description.
...
[CTA 2]
The position sizing formulas and configs are in the free starter pack. Link in the description.
