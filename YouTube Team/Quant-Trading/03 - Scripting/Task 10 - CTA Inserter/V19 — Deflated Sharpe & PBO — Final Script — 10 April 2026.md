# V19 — Deflated Sharpe & PBO — Final Script
...
[CTA 1]
If you want to compute the Deflated Sharpe Ratio and PBO on your own backtests, the free starter pack has the implementation config, the combinatorial matrix setup, and the threshold interpretation guide. In the description.
...
[CTA 2]
The DSR and PBO implementation guide is in the free starter pack. Link in the description.
