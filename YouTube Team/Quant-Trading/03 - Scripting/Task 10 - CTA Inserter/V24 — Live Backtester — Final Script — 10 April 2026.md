# V24 — Live Backtester & Paper Trading — Final Script
...
[CTA 1]
If you want to build a live backtesting engine, the free starter pack has the LiveBacktester spec, the walk-forward config, and the paper trading integration guide. In the description.
...
[CTA 2]
The live backtester config and paper trading setup guide are in the free starter pack — link in the description.
