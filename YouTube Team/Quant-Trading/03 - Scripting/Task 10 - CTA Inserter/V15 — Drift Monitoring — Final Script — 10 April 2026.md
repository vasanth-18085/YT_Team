# V15 — Drift Monitoring — Final Script
...
[CTA 1]
If you want to monitor your own models for drift, the free starter pack includes the seven drift test specs, the alert threshold config, and the monitoring dashboard setup. Grab it from the description.
...
[CTA 2]
The drift monitoring test specs and threshold config are in the free starter pack. Link in the description.
