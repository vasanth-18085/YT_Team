# V22 — Factor Analysis — Final Script
...
[CTA 1]
If you want to decompose your own strategy returns into factor exposures, the free starter pack has the factor model spec, the regression setup, and the alpha interpretation guide. In the description.
...
[CTA 2]
The factor decomposition config is in the free starter pack — link in the description.
