# V20 — Performance Tearsheet — Final Script
...
[CTA 1]
If you want to build your own tearsheet, the free starter pack has the panel specs, the metric definitions, and the QuantStats integration config. Grab it from the description.
...
[CTA 2]
The tearsheet panel specs and metric definitions are in the free starter pack — link in the description.
