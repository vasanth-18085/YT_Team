# V14 — Regime Detection — Final Script
...
[CTA 1]
If you want to add regime detection to your own system, the free starter pack has the HMM config, the regime probability thresholds, and the leverage multiplier rules. In the description.
...
[CTA 2]
The regime detection config and leverage rules are in the free starter pack — link in the description.
