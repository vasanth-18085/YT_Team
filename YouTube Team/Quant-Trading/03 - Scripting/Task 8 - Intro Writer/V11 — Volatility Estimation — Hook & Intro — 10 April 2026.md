...
Recent markets have delivered some of the sharpest volatility spikes in years. If your vol model underestimated risk during those events, every downstream decision — position sizing, risk limits, portfolio allocation — was wrong. This is not a theoretical problem. It is happening right now.
